    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          'RAG는 Gemini 임베딩 모델 기반으로 구축. 한국어 성능과 비용 효율을 고려해 Gemini 임베딩 선택, 문서 특성(섹션별 독립 구조)에 맞는 청킹 전략 적용',
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        label: '분석',
        items: [
          '무중단 배포를 검토했으나, TCP 연결 지향 특성상 한 인스턴스를 내리면 해당 클라이언트들이 살아있는 인스턴스로 집중되어 부하 불균형 발생, 세션 재분배를 위한 전체 재기동 불가피',
